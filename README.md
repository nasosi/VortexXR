...
This software requires the [Json4C4 library](https://github.com/nasosi/Json4C4), and the OpenXR include headers(https://github.com/KhronosGroup/OpenXR-SDK/tree/main/include/openxr).  When not used within the C4 Engine environment, it also requires the [Terathon Container Libraries](https://github.com/EricLengyel/Terathon-Container-Library).
